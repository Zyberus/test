...
var PortfolioSection = dynamic(function () { return import('@/components/PortfolioSection'); }, {
    ssr: false
});
var HeroCanvas = dynamic(function () { return import('@/components/HeroCanvas'); }, {
    ssr: false
});
var features = [
    {
...
export default function Home() {
    ...
    var y = useTransform(scrollYProgress, [0, 1], ['0%', '50%']);
    var opacity = useTransform(scrollYProgress, [0, 0.5], [1, 0]);
    return (<main className="min-h-screen bg-[var(--primary)]" ref={containerRef}>
      ...
      <section className="min-h-[90vh] flex items-center section-padding relative overflow-hidden">
        <motion.div style={{ y: y, opacity: opacity }} className="absolute inset-0 pointer-events-none">
        ...
        <div className="container-width relative">
          <div className="grid lg:grid-cols-2 gap-[var(--space-m)] items-center">
            <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6 }} className="space-y-[var(--space-s)]">
              ...
              <motion.p initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.3 }} className="text-[var(--text-secondary)] text-xl max-w-xl">
              ...
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.6, delay: 0.4 }} className="flex flex-wrap gap-[var(--space-xs)] pt-[var(--space-s)]">
                <Link href="/portfolio">
                ...
                <Link href="/contact" className="group">
                  <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="glass-effect px-8 py-4 rounded-full inline-flex items-center gap-2">
                    Let's Talk
            ...
            <motion.div initial={{ opacity: 0, scale: 0.95 }} animate={{ opacity: 1, scale: 1 }} transition={{ duration: 0.6, delay: 0.2 }} className="relative hidden lg:block h-[500px]">
              <HeroCanvas />
            </motion.div>
          </div>
        </div>
      ...
      <section className="section-padding relative">
        <div className="container-width">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="text-center space-y-[var(--space-s)] mb-[var(--space-xl)]">
          ...
          <div className="grid md:grid-cols-3 gap-[var(--space-m)]">
            {features.map(function (feature, i) { return (<motion.div key={feature.title} initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.5, delay: i * 0.1 }} className="premium-card group">
      ...
      <section className="section-padding">
        <div className="container-width">
          <motion.div initial={{ opacity: 0, y: 20 }} whileInView={{ opacity: 1, y: 0 }} viewport={{ once: true }} transition={{ duration: 0.6 }} className="premium-card text-center relative overflow-hidden">
