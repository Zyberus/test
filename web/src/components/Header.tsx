...
const apps = [
  ...
  { href: '/apps/image-converter', label: 'Image Converter' }
]
              ...
              <div className="relative">
                <button
                  ...
                  className={`flex items-center px-4 py-2 text-sm font-medium rounded-lg transition-all duration-200 ${
                    apps.some(app => pathname === app.href)
                      ? 'text-white bg-white/10'
                      : 'text-zinc-400 hover:text-white hover:bg-white/5'
                  }`}
                >
                  Apps
                  <ChevronDown className={`ml-1 w-4 h-4 transition-transform ${isAppsOpen ? 'rotate-180' : ''}`} />
                </button>
                ...
                <AnimatePresence>
                  {isAppsOpen && (
                    <motion.div
                      ...
                      className="absolute top-full left-0 mt-2 w-48 bg-zinc-900/95 backdrop-blur-sm rounded-lg shadow-lg py-2"
              ...
              <div className="flex flex-col h-full">
                ...
                <nav className="flex-1 px-2 py-4 overflow-y-auto">
                  <ul className="space-y-1">
                    ...
                    {/* Apps Section in Mobile Menu */}
                    <li>
                      <div className="px-4 py-2 text-sm font-semibold text-zinc-500">Apps</div>
                      {apps.map((app) => (
                        <Link
                          key={app.href}
                          href={app.href}
